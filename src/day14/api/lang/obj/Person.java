...
//Object의 clone메서드를 사용하려면 Cloneable이라는 인터페이스를 구현해야함
public class Person extends Object implements Cloneable{
    ...
    public Person makeClone() throws CloneNotSupportedException {
        return (Person)this.clone(); //clone은 retrun타입이 object여서 자식 클래스로 바꿔준다.
    }

    //깊은 복사: Object의 clone은 기본적으로 얕은 복사를 수행함
    //        따라서 이를 재정의하여 깊은 복사로 변경해야함
